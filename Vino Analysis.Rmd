...
# Adjust bin size, cut off upper 1% quantile, adjust x-value to get a better view of the data
# Include mean, 25% and 75% quantile as dashed lines to better see how the bulk of the data is distributed.
# Finally, do some style changes (color & fill)
...
# Adjust bin size, cut off upper 1% quantile, adjust x-value and log scale if necessary to get a better view of the data
# Include mean, 25% and 75% quantile as dashed lines to better see how the bulk of the data is distributed.
# Finally, do some style changes (color & fill)
# Arrange all plots in a grid
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Histogram: Density, Alcohol, Quality
# Adjust bin size, cut off upper 1% quantile, adjust x-value if necessary to get a better view of the data
# Include mean, 25% and 75% quantile as dashed lines to better see how the bulk of the data is distributed.
# Finally, do some style changes (color & fill)
# Arrange all plots in a grid
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Boxplots Acidity against Quality
# Cut off upper 1% quantile, adjust y-value to get a better view of the data
# Include mean as a cross
# Do some style changes (theme, legend, color)
# Arrange all plots in a grid
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Boxplots Sugar & Salts against Quality
# Cut off upper 1% quantile, adjust y-value to get a better view of the data
# Include mean as a cross
# Do some style changes (theme, legend, color)
# Arrange all plots in a grid
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Boxplots Density, Alocohol against Quality
# Cut off upper 1% quantile, adjust y-value to get a better view of the data
# Include mean as a cross
# Do some style changes (theme, legend, color)
# Arrange all plots in a grid
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Grouping function
# To group wines into the categories high, medium, low to find out more about what makes quality vino
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Again Boxplots Density, Alocohol against Quality to see if the trend from the above analysis becomes more evident
# Cut off upper 1% quantile, adjust y-value to get a better view of the data
# Include mean as a cross
# Do some style changes (theme, legend (reverse order), color)
# Arrange all plots in a grid
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# freq poly
# create a frequency polygon to display the described findings in a different way
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# display relationship of density vs sugar
# adjust x and y limits and cut of upper 1% quantile
# include alpha for geom_point to see better where the bulk of the data lies
# include a smoother to see the relationship of the data as a fitted line
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Density vs Sugar vs Alcohol percentage
# adjust x and y limits and cut of upper 1% quantile
# include alpha for geom_point to see better where the bulk of the data lies
# include a smoother to see the relationship of the data as a fitted line
# include title, and x label
...
In this visualization, I did boxplots of density and alcohol percentage against the self-build white-wine-quality-levels "high"", "medium"", "low".
These categories group the subjective wine quality ratings of wine experts into categories with enough data in each category to find trends/ characteristics for each group.
...
We see that wines of the higher quality level seem to have more alcohol and less density.
#### Plot Two
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
# include alpha for geom_point to see better where the bulk of the data lies
# include a smoother to see the relationship of the data as a fitted line
# include title, and x label, y label
...
In this graph I plotted wine density against residual sugar, while including alcohol percenatage as color for each data point.
This visualization lets us observe 2 things: First, sweater wine has more density.
Second, wine with the same sweetness has larger volume of alcohol with lower density.
In other words, given a value of residual sugar, density increases as alcohol decreases. 
...
This chart shows how quality relates with density and residual sugar.
We observe, that for a given residual sugar concentration, quality increases as density increases. The same occurs if you fix density and increase residual sugar.
